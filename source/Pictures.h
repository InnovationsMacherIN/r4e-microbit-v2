...
const MicroBitImage PICTURES[] = {happy, heart, smallHeart, sad, angry, asleep, surprised, yes, no, wink, spaceInvader, arrow_left, arrow_right};
const int storedPictures = 13;